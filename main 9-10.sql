...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2018 at 12:50 AM
...
(59, 'new ', 17, 0, 0.5, '2018-10-06'),
(61, 'new contract', 19, 1, 1.5, '2018-10-06');
...
(19, 59, 1800, '2018-10-06', 0, '0000-00-00', 1.45, 900, '0000-00-00'),
(21, 61, 100, '2018-10-06', 100, '2018-10-06', 1.45, 33, '0000-00-00');
...
(59, 59, 1873, '2018-10-08', '2018-10-09', '0000-00-00', 750),
(61, 61, 3000, '2018-10-08', '2018-10-09', '0000-00-00', 750);
...
--
ALTER TABLE `contracts`
  MODIFY `contract_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `elec`
--
ALTER TABLE `elec`
  MODIFY `elec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `maint`
--
ALTER TABLE `maint`
  MODIFY `maint_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
